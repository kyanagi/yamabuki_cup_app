...
- `app/typescript/controllers`: Stimulusコントローラ
- `app/typescript/scoreboard_react`: スコアボード用Reactコンポーネント
- `app/typescript/entrypoints/*`: エントリーポイント
...
XSS、CSRF、SQLインジェクションを始めとする、Webアプリケーションの脆弱性に対する適切な対策を行ってください。
