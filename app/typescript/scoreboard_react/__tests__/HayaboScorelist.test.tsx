...
import { HayaboScorelist } from "../components/rules/HayaboScorelist";
import { makeScore } from "./helpers";

describe("HayaboScorelist", () => {
  it("同じ選手が連続で得点更新されたとき、2問目でもフリップアニメーションを再実行できる", () => {
    ...
    const playerBefore = container.querySelector("#hayabo-player-3");
    ...
    const playerAfter = container.querySelector("#hayabo-player-3");
