class CreateYontakuPlayerResults < ActiveRecord::Migration[8.0]
  def change
    create_table :yontaku_player_results, comment: "ペーパー結果（点数・順位）" do |t|
      ...
      t.integer :approximation_quiz_diff1, null: false, default: 0, comment: "近似値クイズ1の誤差"
      t.integer :approximation_quiz_diff2, null: false, default: 0, comment: "近似値クイズ2の誤差"
      t.integer :tiebreaker, null: false, default: 0, index: { unique: true }, comment: "近似値まで同点だったときの抽選番号"
